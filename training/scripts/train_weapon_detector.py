# training/scripts/train_weapon_detector.py
#
# Fast-Track YOLOv8n Training for Weapon Detection
...
DATA_YAML = ROOT_DIR / "data" / "weapon_data" / "data.yaml"
OUTPUT_MODEL = BACKEND_MODELS_DIR / "weapon_detector.pt"
...
def train(epochs=3, batch=16, imgsz=416):
    print("=" * 60)
    print("SENTRIX: Fast-Track Weapon Detector (YOLOv8n)")
    ...
    project_dir = ROOT_DIR / "training" / "runs" / "weapon"
